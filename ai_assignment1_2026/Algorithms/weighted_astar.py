...
class weighted_astar(SequentialSearch):
    ...
    def execute_search(self, time_pause):
        # TODO: implement the execute_search method for Weighted A* Search algorithm
        print("TODO: implement the execute_search method for Weighted A* Search algorithm")
        return True
